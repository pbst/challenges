...
static const char rcsid[] __attribute__((__used__)) = "@(#)$File: pread.c,v 1.3 2014/09/15 19:11:25 christos Exp $";
...
ssize_t
pread(int *data_flow, int fd, void *buf, size_t len, off_t off) {
 off_t old;
 ssize_t rv;
