...
static const char rcsid[] __attribute__((__used__)) = "@(#)$File: asctime_r.c,v 1.1 2012/05/15 17:14:36 christos Exp $";
...
char *
asctime_r(int *data_flow, const struct tm *t, char *dst)
{
 char *p = asctime(t);
 if (p == 
         ((void *)0)
