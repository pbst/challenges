...
static const char rcsid[] __attribute__((__used__)) = "@(#)$File: asprintf.c,v 1.4 2010/07/21 16:47:17 christos Exp $";


int asprintf(int *data_flow, char **ptr, const char *fmt, ...)
{
  va_list vargs;
  int retval;
 ...
 fmt
                     ...
                     ;
  retval = vasprintf(data_flow, ptr, fmt, vargs);
