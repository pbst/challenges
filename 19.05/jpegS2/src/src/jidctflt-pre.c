...
extern void jpeg_idct_1x2
    (int *data_flow, j_decompress_ptr cinfo, jpeg_component_info * compptr, JCOEFPTR coef_block, JSAMPARRAY output_buf, JDIMENSION output_col)
                                                                     ;
void
jpeg_idct_float (int *data_flow, j_decompress_ptr cinfo, jpeg_component_info * compptr,
   JCOEFPTR coef_block,
   JSAMPARRAY output_buf, JDIMENSION output_col)
{
  float tmp0, tmp1, tmp2, tmp3, tmp4, tmp5, tmp6, tmp7={0};
  float tmp10, tmp11, tmp12, tmp13={0};
  float z5, z10, z11, z12, z13={0};
  JCOEFPTR inptr={0};
  FLOAT_MULT_TYPE * quantptr={0};
  float * wsptr={0};
  JSAMPROW outptr={0};
 ...
 inptr[8*7] == 0) {
    ...
    tmp10 = z5 - z12 * ((float) 1.082392200);
    tmp12 = z5 - z10 * ((float) 2.613125930);
  ...
  for (ctr = 0; ctr < 8; ctr++) {
    ...
    z5 = wsptr[0] + (((float) (128 << 2)) + ((float) 0.5));
    tmp10 = z5 + wsptr[4];
    tmp11 = z5 - wsptr[4];

    tmp13 = wsptr[2] + wsptr[6];
    tmp12 = (wsptr[2] - wsptr[6]) *
       ((float) 1.414213562) - tmp13;
    ...
    outptr[0] = range_limit[(int) (tmp0 + tmp7) & ((128 << 2) * 2 - 1)];
    outptr[7] = range_limit[(int) (tmp0 - tmp7) & ((128 << 2) * 2 - 1)];
    outptr[1] = range_limit[(int) (tmp1 + tmp6) & ((128 << 2) * 2 - 1)];
    outptr[6] = range_limit[(int) (tmp1 - tmp6) & ((128 << 2) * 2 - 1)];
    outptr[2] = range_limit[(int) (tmp2 + tmp5) & ((128 << 2) * 2 - 1)];
    outptr[5] = range_limit[(int) (tmp2 - tmp5) & ((128 << 2) * 2 - 1)];
    outptr[3] = range_limit[(int) (tmp3 + tmp4) & ((128 << 2) * 2 - 1)];
    outptr[4] = range_limit[(int) (tmp3 - tmp4) & ((128 << 2) * 2 - 1)];
