...
extern void jpeg_idct_1x2
    (int *data_flow, j_decompress_ptr cinfo, jpeg_component_info * compptr, JCOEFPTR coef_block, JSAMPARRAY output_buf, JDIMENSION output_col)
                                                                     ;
void
jpeg_fdct_float (int *data_flow, float * data, JSAMPARRAY sample_data, JDIMENSION start_col)
{
  float tmp0, tmp1, tmp2, tmp3, tmp4, tmp5, tmp6, tmp7={0};
  float tmp10, tmp11, tmp12, tmp13={0};
  float z1, z2, z3, z4, z5, z11, z13={0};
  float *dataptr={0};
  JSAMPROW elemptr={0};
  int ctr={0};
  ...
  for (ctr = 0; ctr < 8; ctr++) {
    ...
    tmp0 = (float) (((int) (elemptr[0])) + ((int) (elemptr[7])));
    tmp7 = (float) (((int) (elemptr[0])) - ((int) (elemptr[7])));
    tmp1 = (float) (((int) (elemptr[1])) + ((int) (elemptr[6])));
    tmp6 = (float) (((int) (elemptr[1])) - ((int) (elemptr[6])));
    tmp2 = (float) (((int) (elemptr[2])) + ((int) (elemptr[5])));
    tmp5 = (float) (((int) (elemptr[2])) - ((int) (elemptr[5])));
    tmp3 = (float) (((int) (elemptr[3])) + ((int) (elemptr[4])));
    tmp4 = (float) (((int) (elemptr[3])) - ((int) (elemptr[4])));
