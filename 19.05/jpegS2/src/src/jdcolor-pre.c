...
static void
ycc_rgb_convert (int *data_flow, j_decompress_ptr cinfo,
   JSAMPIMAGE input_buf, JDIMENSION input_row,
   JSAMPARRAY output_buf, int num_rows)
{
  my_cconvert_ptr cconvert = (my_cconvert_ptr) cinfo->cconvert;
  register int y, cb, cr={0};
  register JSAMPROW outptr={0};
  register JSAMPROW inptr0, inptr1, inptr2={0};
  register JDIMENSION col={0};
...
static void
build_rgb_y_table (int *data_flow, j_decompress_ptr cinfo)
{
  my_cconvert_ptr cconvert = (my_cconvert_ptr) cinfo->cconvert;
  INT32 * rgb_y_tab={0};
  INT32 i={0};
...
static void
rgb_gray_convert (int *data_flow, j_decompress_ptr cinfo,
    JSAMPIMAGE input_buf, JDIMENSION input_row,
    JSAMPARRAY output_buf, int num_rows)
{
  my_cconvert_ptr cconvert = (my_cconvert_ptr) cinfo->cconvert;
  register INT32 * ctab = cconvert->rgb_y_tab;
  register int r, g, b={0};
  register JSAMPROW outptr={0};
  register JSAMPROW inptr0, inptr1, inptr2={0};
  register JDIMENSION col={0};
  JDIMENSION num_cols = cinfo->output_width;
...
static void
rgb1_rgb_convert (int *data_flow, j_decompress_ptr cinfo,
    JSAMPIMAGE input_buf, JDIMENSION input_row,
    JSAMPARRAY output_buf, int num_rows)
{
  register int r, g, b={0};
...
static void
rgb1_gray_convert (int *data_flow, j_decompress_ptr cinfo,
     JSAMPIMAGE input_buf, JDIMENSION input_row,
     JSAMPARRAY output_buf, int num_rows)
{
  my_cconvert_ptr cconvert = (my_cconvert_ptr) cinfo->cconvert;
...
static void
rgb_convert (int *data_flow, j_decompress_ptr cinfo,
      JSAMPIMAGE input_buf, JDIMENSION input_row,
      JSAMPARRAY output_buf, int num_rows)
{
  register JSAMPROW outptr={0};
...
static void
null_convert (int *data_flow, j_decompress_ptr cinfo,
       JSAMPIMAGE input_buf, JDIMENSION input_row,
       JSAMPARRAY output_buf, int num_rows)
{
  int ci={0};
...
static void
grayscale_convert (int *data_flow, j_decompress_ptr cinfo,
     JSAMPIMAGE input_buf, JDIMENSION input_row,
     JSAMPARRAY output_buf, int num_rows)
{
  jcopy_sample_rows(data_flow, input_buf[0], (int) input_row, output_buf, 0,
      num_rows, cinfo->output_width);
}
static void
gray_rgb_convert (int *data_flow, j_decompress_ptr cinfo,
    JSAMPIMAGE input_buf, JDIMENSION input_row,
    JSAMPARRAY output_buf, int num_rows)
{
  register JSAMPROW outptr={0};
...
static void
ycck_cmyk_convert (int *data_flow, j_decompress_ptr cinfo,
     JSAMPIMAGE input_buf, JDIMENSION input_row,
     JSAMPARRAY output_buf, int num_rows)
{
  my_cconvert_ptr cconvert = (my_cconvert_ptr) cinfo->cconvert;
  register int y, cb, cr={0};
  register JSAMPROW outptr={0};
  register JSAMPROW inptr0, inptr1, inptr2, inptr3={0};
  register JDIMENSION col={0};
  JDIMENSION num_cols = cinfo->output_width;
...
static void
start_pass_dcolor (int *data_flow, j_decompress_ptr cinfo)
{
...
void
jinit_color_deconverter (int *data_flow, j_decompress_ptr cinfo)
{
  my_cconvert_ptr cconvert={0};
  int ci={0};
 ...
 ((cinfo)->err->msg_code = (JERR_CONVERSION_NOTIMPL), (*(cinfo)->err->error_exit) (data_flow, (j_common_ptr) (cinfo)));
      ...
      build_rgb_y_table(data_flow, cinfo);
      break;
    default:
      ((cinfo)->err->msg_code = (JERR_CONVERSION_NOTIMPL), (*(cinfo)->err->error_exit) (data_flow, (j_common_ptr) (cinfo)));
    }
