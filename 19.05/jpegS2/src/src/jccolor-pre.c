...
static void
rgb_ycc_start (int *data_flow, j_compress_ptr cinfo)
{
...
static void
rgb_ycc_convert (int *data_flow, j_compress_ptr cinfo,
   ...
   JDIMENSION output_row, int num_rows)
{
  ...
  register JSAMPROW outptr0, outptr1, outptr2={0};
...
static void
rgb_gray_convert (int *data_flow, j_compress_ptr cinfo,
    JSAMPARRAY input_buf, JSAMPIMAGE output_buf,
    JDIMENSION output_row, int num_rows)
{
  my_cconvert_ptr cconvert = (my_cconvert_ptr) cinfo->cconvert;
...
static void
cmyk_ycck_convert (int *data_flow, j_compress_ptr cinfo,
     JSAMPARRAY input_buf, JSAMPIMAGE output_buf,
     JDIMENSION output_row, int num_rows)
{
  my_cconvert_ptr cconvert = (my_cconvert_ptr) cinfo->cconvert;
  ...
  register int r, g, b={0};
  register JSAMPROW inptr={0};
  register JSAMPROW outptr0, outptr1, outptr2, outptr3={0};
  register JDIMENSION col={0};
  JDIMENSION num_cols = cinfo->image_width;
...
static void
rgb_rgb1_convert (int *data_flow, j_compress_ptr cinfo,
    JSAMPARRAY input_buf, JSAMPIMAGE output_buf,
    JDIMENSION output_row, int num_rows)
{
  register int r, g, b={0};
...
static void
grayscale_convert (int *data_flow, j_compress_ptr cinfo,
     JSAMPARRAY input_buf, JSAMPIMAGE output_buf,
     JDIMENSION output_row, int num_rows)
{
...
static void
rgb_convert (int *data_flow, j_compress_ptr cinfo,
      JSAMPARRAY input_buf, JSAMPIMAGE output_buf,
      JDIMENSION output_row, int num_rows)
{
  register JSAMPROW inptr={0};
...
static void
null_convert (int *data_flow, j_compress_ptr cinfo,
       JSAMPARRAY input_buf, JSAMPIMAGE output_buf,
       JDIMENSION output_row, int num_rows)
{
  int ci={0};
...
static void
null_method (int *data_flow, j_compress_ptr cinfo)
{
...
void
jinit_color_converter (int *data_flow, j_compress_ptr cinfo)
{
