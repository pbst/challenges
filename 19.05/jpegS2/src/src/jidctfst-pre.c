...
extern void jpeg_idct_1x2
    (int *data_flow, j_decompress_ptr cinfo, jpeg_component_info * compptr, JCOEFPTR coef_block, JSAMPARRAY output_buf, JDIMENSION output_col)
                                                                     ;
void
jpeg_idct_ifast (int *data_flow, j_decompress_ptr cinfo, jpeg_component_info * compptr,
   JCOEFPTR coef_block,
   JSAMPARRAY output_buf, JDIMENSION output_col)
{
  DCTELEM tmp0, tmp1, tmp2, tmp3, tmp4, tmp5, tmp6, tmp7={0};
  DCTELEM tmp10, tmp11, tmp12, tmp13={0};
  DCTELEM z5, z10, z11, z12, z13={0};
  JCOEFPTR inptr={0};
  IFAST_MULT_TYPE * quantptr={0};
  int * wsptr={0};
  JSAMPROW outptr={0};
 ...
 inptr[8*7] == 0) {
    ...
    tmp10 = z5 - ((DCTELEM) (((z12) * (((INT32) 277))) >> (8)));
    tmp12 = z5 - ((DCTELEM) (((z10) * (((INT32) 669))) >> (8)));
 ...
 wsptr[5] == 0 && wsptr[6] == 0 && wsptr[7] == 0) {
      ...
      JSAMPLE dcval = range_limit[(int) ((z5) >> (2 +3))
      & ((128 << 2) * 2 - 1)];
