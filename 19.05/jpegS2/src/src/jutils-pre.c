...
long
jdiv_round_up (int *data_flow, long a, long b)
...
long
jround_up (int *data_flow, long a, long b)
...
void
jcopy_sample_rows (int *data_flow, JSAMPARRAY input_array, int source_row,
...
void
jcopy_block_row (int *data_flow, JBLOCKROW input_row, JBLOCKROW output_row,
