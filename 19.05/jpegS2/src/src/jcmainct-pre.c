...
static void process_data_simple_main
 (int *data_flow, j_compress_ptr cinfo, JSAMPARRAY input_buf, JDIMENSION *in_row_ctr, JDIMENSION in_rows_avail)
                                                        ;
static void
start_pass_main (int *data_flow, j_compress_ptr cinfo, J_BUF_MODE pass_mode)
{
...
static void
process_data_simple_main (int *data_flow, j_compress_ptr cinfo,
     ...
     JDIMENSION in_rows_avail)
{
  ...
  while (mainp->cur_iMCU_row < cinfo->total_iMCU_rows) {
    ...
    if (mainp->rowgroup_ctr < (JDIMENSION) cinfo->min_DCT_v_scaled_size)
      (*cinfo->prep->pre_process_data) (data_flow, cinfo,
    ...
    if (! (*cinfo->coef->compress_data) (data_flow, cinfo, mainp->buffer)) {
...
void
jinit_c_main_controller (int *data_flow, j_compress_ptr cinfo, boolean need_full_buffer)
{
  my_main_ptr mainp={0};
  int ci={0};
