...
void _af_instparam_get (int *data_flow, AFfilehandle file, int instid, AUpvlist pvlist,
 int npv, 
         _Bool 
              forceLong);

void _af_instparam_set (int *data_flow, AFfilehandle file, int instid, AUpvlist pvlist,
 int npv);

int _af_instparam_index_from_id (int *data_flow, int fileFormat, int id);
int _af_handle_instrument_index_from_id (int *data_flow, AFfilehandle file, int id);
int _af_setup_instrument_index_from_id (int *data_flow, AFfilesetup setup, int id);

extern const _Unit _af_units[];
extern const _CompressionUnit _af_compression[];

AUpvlist _afQueryFileFormat (int *data_flow, int arg1, int arg2, int arg3, int arg4);
AUpvlist _afQueryInstrument (int *data_flow, int arg1, int arg2, int arg3, int arg4);
AUpvlist _afQueryInstrumentParameter (int *data_flow, int arg1, int arg2, int arg3, int arg4);
AUpvlist _afQueryLoop (int *data_flow, int arg1, int arg2, int arg3, int arg4);
AUpvlist _afQueryMarker (int *data_flow, int arg1, int arg2, int arg3, int arg4);
AUpvlist _afQueryMiscellaneous (int *data_flow, int arg1, int arg2, int arg3, int arg4);
AUpvlist _afQueryCompression (int *data_flow, int arg1, int arg2, int arg3, int arg4);
...
AUpvlist afQuery (int *data_flow, int querytype, int arg1, int arg2, int arg3, int arg4)
{
 switch (querytype)
 {
  case AF_QUERYTYPE_INST:
   return _afQueryInstrument(data_flow, arg1, arg2, arg3, arg4);
  case AF_QUERYTYPE_INSTPARAM:
   return _afQueryInstrumentParameter(data_flow, arg1, arg2, arg3, arg4);
  case AF_QUERYTYPE_LOOP:
   return _afQueryLoop(data_flow, arg1, arg2, arg3, arg4);
  case AF_QUERYTYPE_FILEFMT:
   return _afQueryFileFormat(data_flow, arg1, arg2, arg3, arg4);
  case AF_QUERYTYPE_COMPRESSION:
   return _afQueryCompression(data_flow, arg1, arg2, arg3, arg4);
  ...
  case AF_QUERYTYPE_MARK:
   return _afQueryMarker(data_flow, arg1, arg2, arg3, arg4);
  default:
   _af_error(data_flow, AF_BAD_QUERYTYPE, "bad query type");
   return ((struct _AUpvlist *) 0);
 }
...
AUpvlist _afQueryFileFormat (int *data_flow, int arg1, int arg2, int arg3, int arg4)
{
 switch (arg1)
 {
  ...
  case AF_QUERY_ID_COUNT:
  {
   ...
   for (idx = 0; idx < 15; idx++)
    if (_af_units[idx].implemented)
     count++;
   return _af_pv_long(data_flow, count);
  }
  ...
  case AF_QUERY_IDS:
  {
   ...
   buffer = _af_calloc(data_flow, 15, sizeof (int));
   if (buffer == 
                ((void *)0)
                    )
    return ((struct _AUpvlist *) 0);
   ...
   return _af_pv_pointer(data_flow, buffer);
  }
  ...
  case AF_QUERY_LABEL:
   if (arg2 < 0 || arg2 >= 15)
    return ((struct _AUpvlist *) 0);
   return _af_pv_pointer(data_flow, _af_units[arg2].label);

  case AF_QUERY_NAME:
   if (arg2 < 0 || arg2 >= 15)
    return ((struct _AUpvlist *) 0);
   return _af_pv_pointer(data_flow, _af_units[arg2].name);

  case AF_QUERY_DESC:
   if (arg2 < 0 || arg2 >= 15)
    return ((struct _AUpvlist *) 0);
   return _af_pv_pointer(data_flow, _af_units[arg2].description);

  case AF_QUERY_IMPLEMENTED:
   if (arg2 < 0 || arg2 >= 15)
    return ((struct _AUpvlist *) 0);
   return _af_pv_long(data_flow, _af_units[arg2].implemented);
  ...
  case AF_QUERY_SAMPLE_FORMATS:
   ...
   switch (arg2)
   {
    case AF_QUERY_DEFAULT:
     return _af_pv_long(data_flow, _af_units[arg3].defaultSampleFormat);
    default:
     return ((struct _AUpvlist *) 0);
   }
  ...
  case AF_QUERY_SAMPLE_SIZES:
   ...
   {
    case AF_QUERY_DEFAULT:
     return _af_pv_long(data_flow, _af_units[arg3].defaultSampleWidth);
    default:
     break;
   }
  ...
  case AF_QUERY_COMPRESSION_TYPES:
  {
   ...
   if (arg3 < 0 || arg3 >= 15)
   {
    _af_error(data_flow, AF_BAD_QUERY,
   ...
   switch (arg2)
   {
    ...
    case AF_QUERY_VALUES:
     ...
     buffer = _af_calloc(data_flow, count, sizeof (int));
     if (buffer == 
                  ((void *)0)
                      )
      return ((struct _AUpvlist *) 0);
...
long afQueryLong (int *data_flow, int querytype, int arg1, int arg2, int arg3, int arg4)
{
 ...
 list = afQuery(data_flow, querytype, arg1, arg2, arg3, arg4);
 if (list == ((struct _AUpvlist *) 0))
  return -1;
 AUpvgetvaltype(data_flow, list, 0, &type);
 if (type != AU_PVTYPE_LONG)
  return -1;
 AUpvgetval(data_flow, list, 0, &value);
 AUpvfree(data_flow, list);
 return value;
}
...
AUpvlist _afQueryInstrumentParameter (int *data_flow, int arg1, int arg2, int arg3, int arg4)
{
 switch (arg1)
 {
  ...
  case AF_QUERY_SUPPORTED:
   if (arg2 < 0 || arg2 >= 15)
    return ((struct _AUpvlist *) 0);
   return _af_pv_long(data_flow, _af_units[arg2].instrumentParameterCount != 0);

  case AF_QUERY_ID_COUNT:
   if (arg2 < 0 || arg2 >= 15)
    return ((struct _AUpvlist *) 0);
   return _af_pv_long(data_flow, _af_units[arg2].instrumentParameterCount);
  ...
  case AF_QUERY_TYPE:
  {
   ...
   idx = _af_instparam_index_from_id(data_flow, arg2, arg3);
   if (idx<0)
    return ((struct _AUpvlist *) 0);
   return _af_pv_long(data_flow, _af_units[arg2].instrumentParameters[idx].type);
  }
  ...
  case AF_QUERY_NAME:
  {
   ...
   if (idx < 0)
    return ((struct _AUpvlist *) 0);
   return _af_pv_pointer(data_flow, _af_units[arg2].instrumentParameters[idx].name);
  }
  ...
  case AF_QUERY_DEFAULT:
  {
   ...
   if (idx >= 0)
   {
    AUpvlist ret = AUpvnew(data_flow, 1);
    AUpvsetparam(data_flow, ret, 0, _af_units[arg2].instrumentParameters[idx].id);
    AUpvsetvaltype(data_flow, ret, 0, _af_units[arg2].instrumentParameters[idx].type);
    AUpvsetval(data_flow, ret, 0, &_af_units[arg2].instrumentParameters[idx].defaultValue);
    return ret;
   }
   return ((struct _AUpvlist *) 0);
  }
...
AUpvlist _afQueryLoop (int *data_flow, int arg1, int arg2, int arg3, int arg4)
{
 ...
 {
  case AF_QUERY_SUPPORTED:
   return _af_pv_long(data_flow, _af_units[arg2].loopPerInstrumentCount != 0);
  case AF_QUERY_MAX_NUMBER:
   return _af_pv_long(data_flow, _af_units[arg2].loopPerInstrumentCount);
  default:
   break;
 }
...
AUpvlist _afQueryInstrument (int *data_flow, int arg1, int arg2, int arg3, int arg4)
{
 switch (arg1)
 {
  case AF_QUERY_SUPPORTED:
   if (arg2 < 0 || arg2 >= 15)
    return ((struct _AUpvlist *) 0);
   return _af_pv_long(data_flow, _af_units[arg2].instrumentCount != 0);

  case AF_QUERY_MAX_NUMBER:
   if (arg2 < 0 || arg2 >= 15)
    return ((struct _AUpvlist *) 0);
   return _af_pv_long(data_flow, _af_units[arg2].instrumentCount);
...
AUpvlist _afQueryMiscellaneous (int *data_flow, int arg1, int arg2, int arg3, int arg4)
{
 _af_error(data_flow, AF_BAD_NOT_IMPLEMENTED, "not implemented yet");
 return ((struct _AUpvlist *) 0);
}
...
AUpvlist _afQueryMarker (int *data_flow, int arg1, int arg2, int arg3, int arg4)
{
 ...
 {
  case AF_QUERY_SUPPORTED:
   return _af_pv_long(data_flow, _af_units[arg2].markerCount != 0);
  case AF_QUERY_MAX_NUMBER:
   return _af_pv_long(data_flow, _af_units[arg2].markerCount);
  default:
   _af_error(data_flow, AF_BAD_QUERY, "bad query");
   return ((struct _AUpvlist *) 0);
 }
...
AUpvlist _afQueryCompression (int *data_flow, int arg1, int arg2, int arg3, int arg4)
{
 ...
 switch (arg1)
 {
  ...
  case AF_QUERY_IDS:
   buf = _af_calloc(data_flow, 5, sizeof (int));
   if (!buf)
    return ((struct _AUpvlist *) 0);
   ...
   return _af_pv_pointer(data_flow, buf);

  case AF_QUERY_NATIVE_SAMPFMT:
   index = _af_compression_index_from_id(data_flow, arg2);
   return _af_pv_long(data_flow, _af_compression[index].nativeSampleFormat);

  case AF_QUERY_NATIVE_SAMPWIDTH:
   index = _af_compression_index_from_id(data_flow, arg2);
   return _af_pv_long(data_flow, _af_compression[index].nativeSampleWidth);

  case AF_QUERY_LABEL:
   index = _af_compression_index_from_id(data_flow, arg2);
   return _af_pv_pointer(data_flow, _af_compression[index].label);

  case AF_QUERY_NAME:
   index = _af_compression_index_from_id(data_flow, arg2);
   return _af_pv_pointer(data_flow, _af_compression[index].shortname);

  case AF_QUERY_DESC:
   index = _af_compression_index_from_id(data_flow, arg2);
   return _af_pv_pointer(data_flow, _af_compression[index].name);
 }

 _af_error(data_flow, AF_BAD_QUERY, "unrecognized query selector %d\n", arg1);
 return ((struct _AUpvlist *) 0);
}
