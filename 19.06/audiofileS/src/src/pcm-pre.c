...
const _PCMInfo _af_default_signed_integer_pcm_mappings[] =
{
 ...
 {(8388607.0), 0, (-8388608.0), 8388607.0},
 {(2147483647.0), 0, (-2147483648.0), 2147483647.0}
};
...
const _PCMInfo _af_default_unsigned_integer_pcm_mappings[] =
{
 {0, 0, 0, 0},
 {(127.0), (128.0), 0, 255.0},
 {(32767.0), (32768.0), 0, 65535.0},
 {(8388607.0), (8388608.0), 0, 16777215.0},
 {(2147483647.0), (2147483648.0), 0, 4294967295.0}
};
...
void afInitPCMMapping (int *data_flow, AFfilesetup setup, int trackid,
 double slope, double intercept, double minClip, double maxClip)
{
 _TrackSetup *track={0};
...
int afSetVirtualPCMMapping (int *data_flow, AFfilehandle file, int trackid,
 double slope, double intercept, double minClip, double maxClip)
{
 _Track *track={0};
...
int afSetTrackPCMMapping (int *data_flow, AFfilehandle file, int trackid,
 double slope, double intercept, double minClip, double maxClip)
{
 _Track *track={0};
...
void afGetPCMMapping (int *data_flow, AFfilehandle file, int trackid,
 double *slope, double *intercept, double *minClip, double *maxClip)
{
 _Track *track={0};
...
void afGetVirtualPCMMapping (int *data_flow, AFfilehandle file, int trackid,
 double *slope, double *intercept, double *minClip, double *maxClip)
{
 _Track *track={0};
