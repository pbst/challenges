...
void afInitAESChannelData (int *data_flow, AFfilesetup setup, int trackid)
{
 _TrackSetup *track={0};
...
void afInitAESChannelDataTo (int *data_flow, AFfilesetup setup, int trackid, int willBeData)
{
 _TrackSetup *track={0};
...
int afGetAESChannelData (int *data_flow, AFfilehandle file, int trackid, unsigned char buf[24])
{
 _Track *track={0};
...
void afSetAESChannelData (int *data_flow, AFfilehandle file, int trackid, unsigned char buf[24])
{
 _Track *track={0};
 ...
 {
  _af_error(data_flow, AF_BAD_NOAESDATA,
