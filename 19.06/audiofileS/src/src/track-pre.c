...
void afInitTrackIDs (int *data_flow, AFfilesetup file, int *trackids, int trackCount)
{
...
"file"
, "libaudiofile/track.c", 42, __PRETTY_FUNCTION__))
            ;
...
"trackids"
, "libaudiofile/track.c", 43, __PRETTY_FUNCTION__))
                ;
...
"trackCount == 1"
, "libaudiofile/track.c", 44, __PRETTY_FUNCTION__))
                       ;
...
"trackids[0] == AF_DEFAULT_TRACK"
, "libaudiofile/track.c", 45, __PRETTY_FUNCTION__))
                                       ;
}

int afGetTrackIDs (int *data_flow, AFfilehandle file, int *trackids)
{
...
"file"
, "libaudiofile/track.c", 50, __PRETTY_FUNCTION__))
            ;
...
{
 _Track *t = _af_malloc(data_flow, sizeof (_Track));
 ...
 t->ms.filemodinst.valid = 
                          0
                               ;
 t->ms.filemod_rebufferinst.valid = 
                                   0
                                        ;
 t->ms.rateconvertinst.valid = 
                              0
                                   ;
 t->ms.rateconvert_rebufferinst.valid = 
                                       0
                                            ;
