...
void _af_convert_to_ieee_extended (int *data_flow, double num, unsigned char *bytes)
{
 int sign={0};
 int expon={0};
 double fMant, fsMant={0};
 unsigned long hiMant, loMant={0};
 ...
 if (num == 0) {
  ...
  if ((expon > 16384) || !(fMant < 1)) {
   ...
   fsMant = floor(fMant);
   hiMant = ((unsigned long) (((long) (fsMant - 2147483648.0)) + 2147483647L) + 1);
   fMant = ldexp(fMant - fsMant, 32);
   fsMant = floor(fMant);
   loMant = ((unsigned long) (((long) (fsMant - 2147483648.0)) + 2147483647L) + 1);
  }
 }
...
double _af_convert_from_ieee_extended (int *data_flow, const unsigned char *bytes)
{
 ...
 if (expon == 0 && hiMant == 0 && loMant == 0) {
  ...
  if (expon == 0x7FFF) {
   ...
   expon -= 16383;
   f = ldexp((((double) ((long) (hiMant - 2147483647L - 1))) + 2147483648.0), expon-=31);
   f += ldexp((((double) ((long) (loMant - 2147483647L - 1))) + 2147483648.0), expon-=32);
  }
 }
